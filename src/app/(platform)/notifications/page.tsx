...
const TYPE_CONFIG: Record<string, { icon: any; color: string; category: string }> = {
  ...
  new_follower:    { icon: UserPlus, color: 'text-purple', category: 'social' },
  ...
  new_message:     { icon: MessageCircle, color: 'text-purple', category: 'social' },
  message_request: { icon: MessageCircle, color: 'text-cyan', category: 'social' },
  ...
  achievement:     { icon: Award, color: 'text-warning', category: 'system' },
  ...
  cotw:            { icon: Trophy, color: 'text-warning', category: 'competitive' },
  clan_join:       { icon: Users, color: 'text-purple', category: 'social' },
  clan_war_challenge: { icon: Swords, color: 'text-danger', category: 'competitive' },
  clan_war_won:    { icon: Trophy, color: 'text-warning', category: 'competitive' },
  clan_quest_completed: { icon: Award, color: 'text-success', category: 'competitive' },
  game_request:    { icon: Bell, color: 'text-text-dim', category: 'system' },
}
